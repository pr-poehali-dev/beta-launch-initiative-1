    ...
    >
      <div className="fixed top-[-10vh] left-0 h-[120vh] w-full">
        <motion.div style={{ y }} className="relative w-full h-full">
          <img
            src="https://cdn.poehali.dev/projects/3e23ad6a-d960-4004-a7bc-58f1d2e0de46/files/432ec372-431c-47f1-b735-f741dedc6055.jpg"
            alt="Пути русской эмиграции"
      ...
      <p className="absolute bottom-12 right-6 text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-3xl z-10 leading-tight">
        «Россия не в Москве и не в Петрограде — Россия всюду, где её дети помнят и чтут
        свою культуру» — голоса изгнания, 1920-е.
      </p>
    </div>
  );
}